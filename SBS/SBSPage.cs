...
namespace SBS
{
    public class SBSPage : System.Web.UI.Page
    {
        DbConnection _DbConnection;
        DataSet _CalendarEvents;
        protected const string DATBASE_PATH = "~/database/BigWoodsCalendar.mdb";
        ...
        public virtual DataSet CalendarEvents
        {
            ...
            get
            {
                _CalendarEvents = Cache.Get("cache.CalendarEvents") as DataSet;
                ...
                Cache.Insert("cache.CalendarEvents", _CalendarEvents,
        ...
        protected virtual string GetContent(string sPortion)
        {
            ...
            if (Request.QueryString["preview"] != null)
                sPrefix = "./SBScontent/Preview.";
            else
            {
                sPrefix = "./SBScontent/Content.";
        ...
        protected virtual string GenerateMenu()
        {
            ...
            return "<DIV id=menu>" +
                ...
                "<tr><form action=\"Default.aspx\"><td>" +
                "<input type=\"submit\" value=\"Home\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                "</td></form><form action=\"calendar.aspx\"><td>" +
                "<input type=\"submit\" value=\"Calendar\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                "</td></form><form action=\"heyjude.htm\"><td>" +
                "<input type=\"submit\" value=\"Hey Jude\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                //"</td></form><form action=\"LiveCam.aspx\"><td>" +
                //"<input type=\"submit\" value=\"Live Cam\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                "</td></form><form action=\"gallery.aspx\"><td>" +
                "<input type=\"submit\" value=\"Pictures\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                "</td></form><form action=\"news.aspx\"><td>" +
                "<input type=\"submit\" value=\"News\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +

                "</td></form><form action=\"Movies.aspx\"><td>" +
                "<input type=\"submit\" value=\"Multimedia\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +



                "</td></form><form action=\"contact.htm\"><td>" +
                "<input type=\"submit\" value=\"Contact\" onmouseover=\"this.className=\'buttonon\'\" onmouseout=\"this.className=\'button\'\" class=\"button\"><br>" +
